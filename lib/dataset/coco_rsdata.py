...
class COCO(data.Dataset):
    ...
    def __init__(self, opt, split):
        ...
        self.num_classes = 1
        self.class_name = ['__background__', 'plane']
        self._valid_ids = [1]  # Only one class, mapped to ID 1
    ...
    def __getitem__(self, index):
        ...
        for ii in range(seq_num):
            ...
            frame_id = img_id % 1000000
            video_id = img_id // 1000000

            new_frame_id = max(frame_id - ii, 1)
            target_img_id = video_id * 1000000 + new_frame_id
